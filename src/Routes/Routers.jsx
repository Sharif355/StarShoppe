    ...
    children: [
      {
        ...
        loader: () =>
          fetch(
            "    https://brand-shop-server-eplzn76ld-sharif355.vercel.app/brands"
          ),
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `    https://brand-shop-server-eplzn76ld-sharif355.vercel.app/products/${params.brand_name}`
          ),
      },
      {
        ...
        loader: ({ params }) =>
          fetch(
            `    https://brand-shop-server-eplzn76ld-sharif355.vercel.app/products/${params.id}`
          ),
      },
      {
